      ...
      <Flex direction="column" align="stretch" gap={8}>
        <Box textAlign="center" mb={6}>
          ...
          <Text fontSize="xl" maxW="800px" mx="auto">
            Orchestrate multi-agent AI conversations with powerful personas,
            model integration, and real-time collaboration
          </Text>
            ...
            >
              ...
              <Box>
                ...
                <AlertDescription display="block">
                  The backend server is not running yet. To enable full
                  functionality:
                  <Box as="ol" pl={5} mt={2}>
          ...
          {backendStatus === "connected" && (
            ...
            >
              ...
              <Box>
                <AlertTitle>Backend Status</AlertTitle>
                <AlertDescription>
                  The backend server is running. All features are available.
                </AlertDescription>
              </Box>
            </Alert>
          )}
          ...
          <Flex justify="center" mt={6} gap={4}>
            <Button
              ...
              size="lg"
              onClick={() => {
                console.log("HomeView: Create New Conversation button clicked");
                dispatch(openModal("createConversation"));
                console.log(
                  "HomeView: openModal action dispatched for createConversation"
                );
              }}
            >
              New Conversation
        ...
        <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
          <QuickStartCard
            ...
            action={() => {
              console.log("HomeView: Create Persona card action triggered");
              dispatch(openModal("createPersona"));
              console.log(
                "HomeView: openModal action dispatched for createPersona"
              );
            }}
